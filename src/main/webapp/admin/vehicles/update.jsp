...
<head>
  ...
  <title>Edit Vehicle | DriveSwift Admin</title>
  ...
  <div class="hidden md:flex h-screen">
    ...
    <main class="flex-1 p-8 overflow-y-auto">
      <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-semibold text-indigo-700 dark:text-indigo-400">Edit Vehicle</h2>
      ...
      <form method="post" action="${pageContext.request.contextPath}/admin/vehicle" enctype="multipart/form-data"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input name="vehicle_name" type="text" required value="${vehicleData.vehicleName}"
          ...
          <div>
            ...
            <input name="brand" type="text" required value="${vehicleData.brand}"
                   class="w-full px-4 py-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500">
          </div>
          ...
          <div>
            ...
            <input name="model" type="text" required value="${vehicleData.model}"
                   class="w-full px-4 py-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500">
          </div>
          ...
          <div>
            ...
            <input name="vehicle_type" type="text" required value="${vehicleData.vehicleType}"
                   class="w-full px-4 py-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500">
          </div>
          ...
          <div>
            ...
            <input name="cost_per_km" type="number" step="0.01" min="0" required value="${vehicleData.costPerKm}"
                   class="w-full px-4 py-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500">
          </div>
          ...
          <div class="lg:col-span-2">
            ...
            <textarea name="description" rows="4" required
                      class="w-full px-4 py-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500">${vehicleData.description}</textarea>
          </div>

          <!-- Image Upload -->
          <div class="lg:col-span-2">
            <label class="block mb-1 text-sm font-medium">Upload New Image (optional)</label>
            ...
            <div class="mt-4">
              <img src="${pageContext.request.contextPath}/assets/vehicles/${vehicleData.vehicleId}.jpg"
                   alt="Current Vehicle Image"
                   class="w-48 h-32 object-cover rounded border dark:border-gray-600">
            </div>
          </div>
        </div>
